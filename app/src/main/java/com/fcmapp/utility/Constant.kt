...
*/
        ...
        fun getFormatedDateTime(
            ...
            var localStr = ""
            val readFormat = SimpleDateFormat(strReadFormat)
            val writeFormat = SimpleDateFormat(strWriteFormat)
            ...
            if (date != null) {
                ...
                try {
                    localDate = writeFormat.parse(formattedDate)
                    localStr = writeFormat.format(localDate)
                } catch (e: ParseException) {
                    e.printStackTrace()
                }
